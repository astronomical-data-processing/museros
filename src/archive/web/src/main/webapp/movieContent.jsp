...
<div class="main" style="min-height: 600px;">
    <!-- shell -->
    <div class="shell">
        <div class="container"><h1>Processed Movies List</h1>
            ...
            function parseContent(result) {
                ...
                if (result && result.rows && len > 0) {
                    ...
                    for (var i = 0; i < len; i++) {
                        ...
                        html += '            <div class="list-img-link"><a href=image_detail.action?token=0000&imageID=' + record[i].imageID + '>View Detail>></a></div>';
                        html += '        </div>';
