...
<body>
<table id="dg" title="文章列表" class="easyui-datagrid"
       url="../login/user_query.action?"
       toolbar="#toolbar" pagination="true"
       rownumbers="true" fitColumns="true" singleSelect="true">
    <thead>
    <tr>
        <th field="name" width="20">文章标题</th>
        <th field="userName" width="20">文章内容</th>
        <th field="status" width="10">文章状态</th>
        <th field="createTime" formatter=formatDateTime width="20">创建时间</th>
        <th field="modifiedTime" formatter=formatDateTime width="20">修改时间</th>
    </tr>
    </thead>
</table>
<div id="toolbar">
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newUser()">新增文章</a>
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true"
       onclick="editUser()">编辑文章</a>
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="destroyUser()">删除文章</a>
</div>
